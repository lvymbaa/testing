...
namespace MazeGame
{
    ...
    public class Game
    {
        ...
        public void GenerateLevel(GameData data)
        {
            ...
            SetBonusPosition(data, data.bonusAmount);
        ...
        //перемещение игрока в лабиринте
        ...
        //установка позиции выхода игрока
        ...
        //установка позиции сокровища
        public void SetTreasurePosition(GameData data)
        {
        ...
        //установка позиции бонуса на +5 ходов
        public void SetBonusPosition(GameData data, int amount)
        {
        ...
        //проверка бонуса (если игрок находится на позиции бонуса, добавляет 5 шагов)
        ...
        //проверка условия на собранное сокровище
        ...
        public void CheckExit(GameData data)
        {
            if (data.playerPos.Equals(data.exitPos))
            {
                ...
                {
                    Console.WriteLine("Я не могу выйти без сокровища!(");
                }
            }
        }

        //проверка условия на завершение количества ходов игрока
        public bool CheckGameOver(GameData data)
        {
            if (data.bonusTurnAmount + data.turnAmount <= 0)
            {
                Console.WriteLine("Увы, ходы закончились!");
                return true;
            } else
            {
                return false;
        ...
        //генерация лабиринта
        public void MazeGeneration(GameData data)
        {
        ...
        //вычисление кратчайшего пути (в клетках) до выхода
